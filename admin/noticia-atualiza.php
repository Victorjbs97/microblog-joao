    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if( empty($_POST['titulo']) || empty($_POST['texto'])|| empty($_POST['resumo']) ){
            ...
            try {
                ...
                /* Se o usuário enviar uma nova imagem e não tiver erro no envio, Vamos fazer um novo upload, caso contrario vamos manter a imagem atual. */
                ...
                if(!empty($arquivo) && $arquivo['error'] === UPLOAD_ERR_OK){
                    ...
                    //Aproveitamos para pegar apenas o nome e extensão do arquivo.
                    $imagem = $arquivo['name'];
                }else{
                    //Caso contrario mantemos a imagem existente
                    $imagem = $dados['imagem'];
                }
                ...
                // Atualizar noticia passando ela e o tipo de usuário que está logado.
